...
export default function ContactPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-extrabold text-espresso mb-5">Get a Quote</h1>
      ...
      <div className="bg-espresso text-white rounded-2xl p-8 mb-10 text-center">
        <p className="text-lg mb-3">Call or text, 7 days a week:</p>
        <a href={site.phoneHref} className="inline-block bg-copper text-white font-bold text-2xl px-8 py-4 rounded-lg">
          📞 {site.phone}
        </a>
      ...
      <QuoteForm />
      <p className="text-mist mt-4">We reply the same day — usually within a couple of hours.</p>
    </div>
  );
}
