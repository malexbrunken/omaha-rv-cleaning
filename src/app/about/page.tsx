...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-extrabold text-espresso mb-5">About Omaha RV Cleaning Co.</h1>
      ...
      <h2 className="text-2xl font-bold text-espresso mb-3">Our story</h2>
      <p className="mb-5">
      ...
      <h2 className="text-2xl font-bold text-espresso mb-3">What makes us different</h2>
      <ul className="space-y-3 mb-8 text-lg">
        ...
        <li><strong>Published pricing.</strong> Real numbers on our <Link href="/pricing" className="text-copper underline font-semibold">pricing page</Link>, because a fair price shouldn&apos;t be a secret.</li>
      ...
      <h2 className="text-2xl font-bold text-espresso mb-3">The way we work</h2>
      <p className="mb-8">
      ...
      <div className="bg-cream border border-line rounded-2xl p-8 text-center">
        <p className="text-xl font-bold text-espresso mb-4">Questions? We&apos;re happy to talk.</p>
